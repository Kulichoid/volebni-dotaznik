...
<body>
  ...
  <main id="uvod">
    ...
    <section class="about-section content-width" id="o-ankete" aria-labelledby="about-title"><div class="about-intro"><span class="eyebrow">O ANKETĚ · TEREZA VRÁNOVÁ</span><h2 id="about-title">Barrandov je můj domov.</h2>
<p>Od roku 1994 žiji na Barrandově. Vyrostla jsem zde a založila rodinu, a proto mi není lhostejné, kam Barrandov směřuje a jak se bude dál rozvíjet.</p>
<p>Sesbírala jsem proto nejčastější otázky a témata, která mezi obyvateli Barrandova rezonují, a položila je stranám kandidujícím v komunálních volbách. Jejich odpovědi najdete přehledně na tomto webu.</p>
<p>Všem jsem položila stejné otázky a stanovila stejný termín pro odpověď. Ti, kteří zatím neodpověděli, mohou své odpovědi kdykoli doplnit. Zveřejním je s informací, že byly dodány dodatečně.</p>
<p>Mým cílem je nabídnout vám jednoduché srovnání postojů jednotlivých stran a usnadnit rozhodování před volbami.</p>
<p>Přeji nám všem šťastnou volbu.<br><strong>Tereza Vránová</strong></p>
<p>V případě dotazů mě můžete kontaktovat na e-mailu <a class="text-link" href="mailto:teroid.vrana@gmail.com">teroid.vrana@gmail.com</a>.</p><a class="text-link" href="#odpovedi">Zpátky k odpovědím ${icon("arrow")}</a></div><div class="about-points"><article><span>01</span><div><h3>Stejný prostor pro všechny</h3><p>Jednotné otázky a stejné podmínky pro prezentaci každého kandidujícího uskupení.</p></div></article><article><span>02</span><div><h3>Vlastní názor je na vás</h3><p>Anketa nesestavuje žebříček ani nedoporučuje, koho volit. Pomáhá číst a porovnávat odpovědi.</p></div></article><article><span>03</span><div><h3>Jasně označený obsah</h3><p>Zveřejňujeme dodané odpovědi bez obsahových úprav. Vynechány jsou pouze e-mailové hlavičky, pozdravy a kontaktní údaje; sjednoceno je zalomení textu. U uskupení, která zatím neodpověděla, tuto skutečnost uvádíme.</p></div></article></div></section>
